...
| `crates/llvmkit-ir/src/ir_builder.rs::folder_validation_tests::checked_folded_value_rejects_foreign_result` | `llvm/include/llvm/IR/IRBuilderFolder.h` `Value*` folder hook contract | llvmkit-specific validation |
