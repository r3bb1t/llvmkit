...
| `crates/llvmkit-asmparser/tests/parser_constants.rs::constant_expr_binary_identity_folds_like_upstream` | `test/Assembler/ConstantExprFold.ll` integer-binary constant-expression identity-fold FileCheck lines | mirror |
...
| `crates/llvmkit-ir/tests/constants_expr.rs::constant_expr_bitcast_round_trips` | `llvm/lib/IR/ConstantFold.cpp::FoldBitCast` PPC_FP128 target-independent no-fold rule; `llvm/lib/IR/AsmWriter.cpp::writeConstantInternal` `bitcast` constant-expression arm | llvmkit-specific subset |
...
| `crates/llvmkit-ir/tests/constant_fold.rs::insertelement_fixed_vector_replaces_lane` | `llvm/lib/IR/ConstantFold.cpp::ConstantFoldInsertElementInstruction` fixed-vector in-range index rebuild behavior | llvmkit-specific subset |
| `crates/llvmkit-ir/tests/constant_fold.rs::shufflevector_fixed_mask_selects_lanes` | `llvm/lib/IR/ConstantFold.cpp::ConstantFoldShuffleVectorInstruction` fixed-mask lane selection and poison mask element behavior | llvmkit-specific subset |
...
| `crates/llvmkit-ir/tests/constant_folder_builder.rs::constant_folder_exact_udiv_inexact_constants_fold_to_poison` | `llvm/include/llvm/IR/ConstantFolder.h::ConstantFolder::FoldExactBinOp`; `llvm/lib/IR/ConstantFold.cpp::ConstantFoldBinaryInstruction` exact division poison behavior | llvmkit-specific subset |
