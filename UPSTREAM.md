...
| `crates/llvmkit-asmparser/tests/parser_forward_refs.rs::forward_global_reference_signature_mismatch_is_rejected` | `test/Assembler/2002-05-02-InvalidForwardRef.ll` forward function resolution shape; `llvm/lib/AsmParser/LLParser.cpp::parseCall` callee type checking | llvmkit-specific regression |
