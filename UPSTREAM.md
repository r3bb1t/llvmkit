...
| `crates/llvmkit-ir/tests/builder_typestate_termination.rs::cond_br_terminator_seals_block` | `unittests/IR/IRBuilderTest.cpp::TEST_F(IRBuilderTest, CreateCondBr)` | port |
...
| `crates/llvmkit-ir/tests/builder_typestate_termination.rs::seal_typestate_does_not_change_asm_output` | `unittests/IR/IRBuilderTest.cpp::TEST_F(IRBuilderTest, CreateCondBr)` | llvmkit-specific |
