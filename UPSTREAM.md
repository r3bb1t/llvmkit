...
| `crates/llvmkit-ir/tests/verifier_basic.rs::verify_represented_intrinsic_mismatch_fails` | `llvm/include/llvm/IR/Intrinsics.td`; `llvm/lib/IR/Verifier.cpp` intrinsic validation | mirror |
...
| `crates/llvmkit-ir/tests/constant_folder_builder.rs::custom_folder_foreign_error_is_propagated` | `llvm/include/llvm/IR/IRBuilderFolder.h` `Value*` folder hook contract | llvmkit-specific validation |
| `crates/llvmkit-ir/tests/constant_folder_builder.rs::custom_folder_foreign_value_is_rejected` | `llvm/include/llvm/IR/IRBuilderFolder.h` `Value*` folder hook contract; llvmkit cross-module rejection on folded values | llvmkit-specific validation |
