...
use llvmkit_ir::{ConstantIntValue, IrError, module_new};
...
fn int_signs_i8_round_trips() -> Result<(), IrError> {
    ...
    let pos: ConstantIntValue<'_, i8, _> = i8_ty.const_int(100_i8);
    ...
    let neg: ConstantIntValue<'_, i8, _> = i8_ty.const_int(-50_i8);
...
fn int_signs_i32_propagates_sign() -> Result<(), IrError> {
    ...
    let max: ConstantIntValue<'_, i32, _> = i32_ty.const_int(i32::MAX);
    ...
    let min: ConstantIntValue<'_, i32, _> = i32_ty.const_int(i32::MIN);
    ...
    let neg_one: ConstantIntValue<'_, i32, _> = i32_ty.const_int(-1_i32);
...
fn int_signs_i1_sign_extends_to_minus_one() -> Result<(), IrError> {
    ...
    let one_bit_true: ConstantIntValue<'_, bool, _> = i1_ty.const_int(true);
    ...
    let one_bit_false: ConstantIntValue<'_, bool, _> = i1_ty.const_int(false);
